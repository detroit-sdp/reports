...
Milestone 3: Connectivity of systems
    
Pathfinding
    Can navigate between rooms on it's own without line of tape
...
Milestone 4: Full pathfinding and Connectivity 

Pathfinding
    Can navigate carefully around obstacles       
    
    
    Robot can navigate between rooms without a line tape path
    
App connectivity 
    Robot can recieve Calender timetable and database information from the app to plan it's route through the rooms and to know who needs which medications at what times.
