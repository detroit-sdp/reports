...
Nurses and healthcare assistants are overworked: with high patient loads per nurse across the NHS, they spend a large amount of time on menial tasks, limiting the amount of time they can spend caring for patients. Our assistive healthcare robot that allows nurses and healthcare assistants to automate certain menial tasks, allowing them to spend less time on the menial work, and more time doing what matters: caring for their patients. 
