...
\begin{table*}[]
  ...
  \begin{tabular}{|c|l|l|l|c|}
    ...
    4               & B.4: Maintainence & - & Debugging, testing, analysis & 80\\ \hline
                    &                           &  & {\bf Total} & 500 \\ \hline
  \end{tabular}
  \end{small}
...
\begin{table*}[]
  ...
  \begin{tabular}{|c|l|l|l|c|}
    ...
    3               & A.3.1: Timetable of deliveries & - & Communication (RP team) & 40\\ \cline{2-5}
                    & A.3.2: Timetable wakeup alarm & Access to bot & Networking features & 30\\ \cline{2-5}
