...
\par Another feature we have worked on is a prioritisation system allowing the caregivers to see which of the residents is more likely to need assistance. In the future it future will be used in the scheduling of the robot by deciding the order of who the robot should visit next.
